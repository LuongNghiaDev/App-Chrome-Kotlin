...
import com.example.appggkotlin.databinding.FragmentBrowserBinding
    ...
    override fun onContextItemSelected(item: MenuItem): Boolean {
        ...
        when(item.title){
            ...
            "Open Tab in Background" ->{
                changeTab(url.toString(), BrowserFragment(url.toString()), isBackground = true)
            }
            "View Image" ->{
                if(imgUrl != null) {
                    ...
                    else changeTab(imgUrl, BrowserFragment(imgUrl))
                }
            }
