...
import com.example.appggkotlin.databinding.ActivityMainBinding
import com.example.appggkotlin.databinding.BookmarkDialogBinding
import com.example.appggkotlin.databinding.MoreFeaturesBinding
import com.example.appggkotlin.databinding.TabsViewBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onBackPressed() {
        var frag: BrowserFragment? = null
        try {
            frag = tabsList[binding.myPager.currentItem].fragment as BrowserFragment
        }catch (e:Exception){}
        ...
        binding.tabsBtn.setOnClickListener {
            ...
            val dialogTabs = MaterialAlertDialogBuilder(this, R.style.roundCornerDialog).setView(viewTabs)
                ...
                .setNeutralButton("Google"){self, _ ->
                    changeTab("Google", BrowserFragment(urlNew = "www.google.com"))
                    self.dismiss()
                }
                .create()
...
fun changeTab(url: String, fragment: Fragment, isBackground: Boolean = false){
    ...
    if(!isBackground) MainActivity.myPager.currentItem = MainActivity.tabsList.size - 1
}
